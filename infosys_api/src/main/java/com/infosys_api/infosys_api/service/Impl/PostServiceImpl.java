...
import com.infosys_api.infosys_api.exception.ResourceNotFoundException;
...
public class PostServiceImpl implements PostService {
    ...
    public PostDto getPostById(long id) {
        Post post = postRepository.findById(id).orElseThrow(
                () -> new ResourceNotFoundException("The post is not found with id : " + id) // lamda expresssion
        );
    ...
    public PostDto updatePost(long id, PostDto postDto) {
        Post post = postRepository.findById(id).orElseThrow(
                () -> new ResourceNotFoundException("The post is not found with id : " + id)
        );
